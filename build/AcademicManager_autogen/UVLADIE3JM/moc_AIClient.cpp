...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AIClient_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_AIClient_t qt_meta_stringdata_AIClient = {
    {
        QT_MOC_LITERAL(0, 8)   // "AIClient"
    },
    "AIClient"
};
...
Q_CONSTINIT static const uint qt_meta_data_AIClient[] = {
...
Q_CONSTINIT const QMetaObject AIClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_AIClient.offsetsAndSizes,
    qt_meta_data_AIClient,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AIClient_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AIClient, std::true_type>
    >,
    nullptr
} };
